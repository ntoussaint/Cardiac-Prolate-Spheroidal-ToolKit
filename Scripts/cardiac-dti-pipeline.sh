...
#cpstk extract -i tensors.vtk -pr prolatetransform.tfm -f1 1-to-2.mha -f2 2-to-1.mha -t helix -o helix-angles.csv
#cpstk extract -i tensors.vtk -pr prolatetransform.tfm -f1 1-to-2.mha -f2 2-to-1.mha -t transverse -o transverse-angles.csv
#cpstk extract -i tensors.vtk -pr prolatetransform.tfm -f1 1-to-2.mha -f2 2-to-1.mha -t sheet -o sheet-angles.csv
#cpstk extract -i tensors.vtk -pr prolatetransform.tfm -f1 1-to-2.mha -f2 2-to-1.mha -t cl-cp-cs -o cl-cp-cs.csv
#ttk tractography -i tensors.mha -fa1 0.2 -fa2 0.2 -s 0.2 -fs 2.0 -n 2 -o fibres.fib -c 1
#cpstk colorify -i fibres.fib -pr prolatetransform.tfm -f1 1-to-2.mha -f2 2-to-1.mha -t helix -o fibres-helix.vtk
