...
MeshType::Pointer DomainToMesh (typename ImageType::Pointer image)
{
...
namespace itk
{
  ...
  MeshType::Pointer domaincartesian = DomainToMesh (domainimage);
  ...
  UnNormalizeFirstComponent (data, range);
