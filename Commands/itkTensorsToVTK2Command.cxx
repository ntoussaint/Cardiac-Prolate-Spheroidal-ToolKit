#include "itkTensorsToVTK2Command.h"
...
namespace itk
{
  ...
  TensorsToVTK2Command::TensorsToVTK2Command()
  {
    m_ShortDescription = "Convert a list of tensor images into a list ofvtkUnstructuredGrid structures";
    m_LongDescription = m_ShortDescription;
    m_LongDescription += "\n\nUsage:\n";
    m_LongDescription +="-i  [list of images (.list)]\n";    
    m_LongDescription +="-m  [list of mask images]\n";
  ...
  int TensorsToVTK2Command::Execute (int narg, const char* arg[])
  {
    ...
    maskreader->SetFileName( masks );
    if (cl.search(2,"-m","-M"))
    {
      
      std::cout << "Reading: " << masks << std::flush;
      try
      {
	maskreader->Update();
      }
