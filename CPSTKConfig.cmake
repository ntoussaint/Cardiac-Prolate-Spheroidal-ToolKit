...
# The build settings file.
SET(CPSTK_BUILD_SETTINGS_FILE ${CPSTK_BINARY_DIR}/lib/CPSTKBuildSettings.cmake)

# Link directories.
IF(CYGWIN AND BUILD_SHARED_LIBS)
  # In Cygwin programs directly link to the .dll files.
  SET(CPSTK_LIBRARY_DIRS_CONFIG ${CPSTK_BINARY_DIR}/bin)
ELSE(CYGWIN AND BUILD_SHARED_LIBS)
  SET(CPSTK_LIBRARY_DIRS_CONFIG ${CPSTK_BINARY_DIR}/lib)
ENDIF(CYGWIN AND BUILD_SHARED_LIBS)

# Runtime directories.
IF(WIN32)
  SET(CPSTK_RUNTIME_LIBRARY_DIRS_CONFIG ${CPSTK_BINARY_DIR}/bin)
ELSE(WIN32)
  SET(CPSTK_RUNTIME_LIBRARY_DIRS_CONFIG ${CPSTK_BINARY_DIR}/lib)
ENDIF(WIN32)
...
INSTALL_FILES(/lib FILES ${CPSTK_BINARY_DIR}/CPSTKConfig.cmake)