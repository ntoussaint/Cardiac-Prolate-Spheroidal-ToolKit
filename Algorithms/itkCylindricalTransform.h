...
Module:    $Id: itkCylindricalTransform.h 1 2010-05-21 14:00:33Z nt08 $
Language:  C++
Author:    $Author: nt08 $
...
=========================================================================*/
#ifndef _itk_CylindricalTransform_h_
#define _itk_CylindricalTransform_h_
...
namespace itk
{
  ...
  /**
     \class CylindricalTransform (itk)
     \brief Transformation class from Cartesian coordinates to Cylindrical Spheroidal Coordinates.
     
     CylindricalTransform is a transformation. Input parameters are 3 points defining a prolate
     ...
     The coordinate change can be "Forward" - from Cartesian towards Cylindrical Spheroidal Coordinates - or
     "Backward" - from Cylindrical Spheroidal towards Cartesian coordinates. Control the direction of the transform
     ...
     \sa CylindricalSpheroidTransformTensorFilter
     \sa Transform
  ...
  */
  ...
  class ITK_EXPORT CylindricalTransform : public Transform<TPixelType, 3, 3>
  {
  public:
    typedef CylindricalTransform Self;
    ...
    itkNewMacro (Self);
    itkTypeMacro (CylindricalTransform, Transform);

    /**
       Set the direction of the transformation. If Forward is set to 1, then the transformation is
       from Cartesian towards Cylindrical Spheroidal coordinates, and vice-versa.
    */
    ...
    /**
       ...
       coordinates - as the center point has [0,0,0] as Cylindrical Spheroidal coordinates by definition.
    */
    ...
    */
    ...
    {
      if (t.GetSize())
	itkWarningMacro( << "There is no fixed parameters in a CylindricalTransform" );
    }
    ...
    */
    ...
    /**
       from an input point \arg x (in Cartesian if Forward / in Cylindrical if !forward),
    ...
    */
    virtual PointType ToCylindrical(PointType x) const;

    virtual VectorType ToCartesian (VectorType v, PointType p) const;
    virtual VectorType ToCylindrical (VectorType v, PointType p) const;
  ...
  private :
    CylindricalTransform(const Self&);
...
#include "itkCylindricalTransform.txx"
#endif
