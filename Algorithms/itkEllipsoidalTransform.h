...
namespace itk
{
  ...
  /**
     ...
     EllipsoidalTransform is a transformation. Input parameters are 3 points defining a prolate
  ...
  */
  ...
  template <class TPixelType=double>
    ...
    itkNewMacro (Self);
    itkTypeMacro (EllipsoidalTransform, Transform);
    ...
    */
    ...
    /**
       ...
       coordinates.
    */
    virtual void SetShortAxisPoint1 (PointType point)
    {
      m_ShortAxisPoint1 = point;
      this->ComputeTransformation();
    }
    /**
       Set the short axis point of the ellipsoid separately. Of course it has to be in Cartesian
       coordinates.
    */
    virtual void SetShortAxisPoint2 (PointType point)
    {
      m_ShortAxisPoint2 = point;
      this->ComputeTransformation();
    }
    /**
    ...
    */
    virtual void DefineEllipsoid (PointType center,
				  ...
				  PointType shortaxispoint1,
				  PointType shortaxispoint2)
    {
      m_Center = center;
      m_LongAxisPoint = longaxispoint;
      m_ShortAxisPoint1 = shortaxispoint1;
      m_ShortAxisPoint2 = shortaxispoint2;
      this->ComputeTransformation();
    }
    ...
    {
      if (t.GetSize())
	itkWarningMacro( << "There is no fixed parameters in a EllipsoidalTransform" );
    }
    ...
    */
    ...
    /// Recover the spheroid semi foci distance 1 (a) 
    ...
    */
    ...
    PointType m_ShortAxisPoint1;
    PointType m_ShortAxisPoint2;
    VectorType m_Axis1;
    VectorType m_Axis2;
    VectorType m_Axis3;
...
#include "itkEllipsoidalTransform.txx"
#endif
