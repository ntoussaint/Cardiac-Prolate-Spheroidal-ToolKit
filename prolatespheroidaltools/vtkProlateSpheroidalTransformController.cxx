...
//----------------------------------------------------------------------------
vtkProlateSpheroidalTransformControllerCommand::vtkProlateSpheroidalTransformControllerCommand()
{
...
//----------------------------------------------------------------------------
void vtkProlateSpheroidalTransformControllerCommand::SetController (vtkProlateSpheroidalTransformController* arg)
{
...
//----------------------------------------------------------------------------
void vtkProlateSpheroidalTransformControllerCommand::Execute ( vtkObject *caller, unsigned long event, void *vtkNotUsed(callData))
{
...
//----------------------------------------------------------------------------
vtkProlateSpheroidalTransformController::vtkProlateSpheroidalTransformController()
{
  ...
  this->Command            = vtkProlateSpheroidalTransformControllerCommand::New();
...
//----------------------------------------------------------------------------
void vtkProlateSpheroidalTransformController::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os,indent);
}

//----------------------------------------------------------------------------
void vtkProlateSpheroidalTransformController::SetInteractorCollection (vtkCollection* arg)
{
...
//----------------------------------------------------------------------------
void vtkProlateSpheroidalTransformController::SetInput(ImageType::Pointer input)
{
  m_Input = input;
...
//----------------------------------------------------------------------------
void vtkProlateSpheroidalTransformController::SetTransform (TransformType::Pointer arg)
{
  m_Transform = arg;
...
void vtkProlateSpheroidalTransformController::SetTransform (vtkPointSet* arg)
{
  if (!arg->GetPoints()->GetNumberOfPoints() || (arg->GetNumberOfPoints() != 3) )
  {
    vtkErrorMacro (<<"vtkProlateSpheroidalTransformController::SetConstraints() : argument not compatible");
    return;
  }
  ...
  transform->DefineEllipsoid (p1,p2,p3);
  this->SetTransform (transform);
}


//----------------------------------------------------------------------------
void vtkProlateSpheroidalTransformController::GuessTransform (vtkPointSet* arg)
{
...
//----------------------------------------------------------------------------
vtkLandmarkWidget* vtkProlateSpheroidalTransformController::AddConstraint (double* pos, int type)
{
  if (!this->InteractorCollection)
    return NULL;
...
//----------------------------------------------------------------------------
void vtkProlateSpheroidalTransformController::RemoveAllConstraints (void)
{
...
//----------------------------------------------------------------------------
void vtkProlateSpheroidalTransformController::RefreshConstraints (void)
{
...
//----------------------------------------------------------------------------
void vtkProlateSpheroidalTransformController::GetLandmarkSet(vtkPolyData* arg)
{
...
//----------------------------------------------------------------------------
void vtkProlateSpheroidalTransformController::SetEnabled (unsigned int arg)
{
  this->Enabled = arg;
...
//----------------------------------------------------------------------------
void vtkProlateSpheroidalTransformController::LinkInteractions ( void)
{ 
...
//----------------------------------------------------------------------------
void vtkProlateSpheroidalTransformController::CreateGrid (TransformType::Pointer transform,
...
//----------------------------------------------------------------------------
void vtkProlateSpheroidalTransformController::VerifyOrthogonality (void)
{
  vtkLandmarkWidget* landmark = NULL;
  landmark = vtkLandmarkWidget::SafeDownCast (this->LandmarkCollection->GetItemAsObject(0));
  PointType p1 (landmark->GetCenter());
...
//----------------------------------------------------------------------------
int vtkProlateSpheroidalTransformController::RequestData(
  ...
  vtkInformationVector *outputVector)
{
  ...
  unsigned int circumdivisions = 30;
  ...
  double mu1 = asinh ((m_Transform->GetLambda2() - thickness/2.0) / m_Transform->GetSemiFociDistance());
  double mu2 = asinh ((m_Transform->GetLambda2() + thickness/2.0) / m_Transform->GetSemiFociDistance());
  double nu1 = 0.0;
  ...
  PointType basalpoint; basalpoint[0] = (mu2 + mu1) / 2.0; basalpoint[1] = nu2; basalpoint[2] = 0.0;
  basalpoint = inversetransform->TransformPoint (basalpoint);
  VectorType longaxis; longaxis = -m_Transform->GetAxis1();
