...
void PrintHelp(const char* exec)
{
  ...
  std::cout << "-p  [optional initial ellipsoidal-transform file]" << std::endl;
...
public:
  ...
  virtual void Execute(vtkObject *caller,unsigned long event, void *vtkNotUsed(callData))
  {
	...
	std::cout<<this->Controller->GetTransform()<<std::endl;
...
int main (int argc, char* argv[])
{
  ...
  typedef vtkEllipsoidalTransformController::ScalarType ScalarType;
  typedef vtkEllipsoidalTransformController::ImageType  ImageType;
  typedef vtkEllipsoidalTransformController::TransformType  TransformType;
  typedef itk::ImageFileReader<ImageType>               ReaderType;
  typedef itk::ImageToVTKImageFilter<ImageType>         ConverterType;
  typedef ImageType::DirectionType                      DirectionType;
  typedef ImageType::PointType                          PointType;
  ...
  // --------------------------------------------------------
  // ---- Part concerning Ellipsoidal Generation -----
  // --------------------------------------------------------
  ...
  vtkEllipsoidalTransformController* controller = vtkEllipsoidalTransformController::New();
  ...
  // --------------------------------------------------------
  // -- End Part concerning Ellipsoidal Generation ---
  // --------------------------------------------------------
