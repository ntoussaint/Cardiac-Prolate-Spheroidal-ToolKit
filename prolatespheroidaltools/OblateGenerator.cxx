...
void PrintHelp(const char* exec)
{
  ...
  std::cout << "-p  [optional initial oblate-transform file]" << std::endl;
...
int main (int argc, char* argv[])
{
  ...
  typedef vtkOblateSpheroidalTransformController::ScalarType ScalarType;
  typedef vtkOblateSpheroidalTransformController::ImageType  ImageType;
  typedef vtkOblateSpheroidalTransformController::TransformType  TransformType;
  typedef itk::ImageFileReader<ImageType>               ReaderType;
  typedef itk::ImageToVTKImageFilter<ImageType>         ConverterType;
  typedef ImageType::DirectionType                      DirectionType;
  typedef ImageType::PointType                          PointType;
  ...
  // --------------------------------------------------------
  // ---- Part concerning Oblate Spheroidal Generation -----
  // --------------------------------------------------------
  ...
  vtkOblateSpheroidalTransformController* controller = vtkOblateSpheroidalTransformController::New();
  ...
  // --------------------------------------------------------
  // -- End Part concerning Oblate Spheroidal Generation ---
  // --------------------------------------------------------
